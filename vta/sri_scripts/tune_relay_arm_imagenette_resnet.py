...
# network = resnet18_base
network = resnet18_base_orig_dense
...
def get_network(name, batch_size):
    ...
    if "resnet" in name:
        ...
        scripted_model = torch.jit.trace(network, input_data)
...
log_file = "logs/tuning_logs/vta_2x16x16/arm_cpu_dense_%s.%s.log" % (device_key, network_name)
dtype = "float32"
...
def tune_and_evaluate(tuning_opt):
    ...
    print("Extract tasks...")
    mod, params, input_shape, _ = get_network(network_name, batch_size=2)
