...
def extract_features(file_path):
    ...
    return [mean_power, std_power, skewness_power, kurtosis_power, range_power, mean_freq_power, std_freq_power]
    # return [mean_power, std_power, mean_freq_power, std_freq_power]
    # return [mean_power, std_power, skewness_power, kurtosis_power]
...
features_1x8x32 = load_dataset('1x8x32_rcg', 3)

# Combine datasets
dataset = features_1x16x16 + features_4x8x8 + features_2x16x16 + features_1x8x32
columns = ['mean_power', 'std_power', 'skewness_power', 'kurtosis_power', 'range_power', 'mean_freq_power', 'std_freq_power', 'label']
# columns = ['mean_power', 'std_power', 'mean_freq_power', 'std_freq_power', 'label']
# columns = ['mean_power', 'std_power', 'skewness_power', 'kurtosis_power', 'label']
df = pd.DataFrame(dataset, columns=columns)

# perform k-fold cross validation and save model with best accuracy
...
# file_1x8x32 = 'resnet18_pmbus_1x8x32.csv'
#
...
# features_1x8x32 = [extract_features(file_1x8x32)]
#
# columns = ['mean_power', 'std_power', 'skewness_power', 'kurtosis_power', 'range_power', 'mean_freq_power', 'std_freq_power']
# # columns = ['mean_power', 'std_power', 'mean_freq_power', 'std_freq_power']
#
...
# df_1x8x32 = pd.DataFrame(features_1x8x32, columns=columns)
#
#
...
# prediction_1x8x32 = model.predict(df_1x8x32)
#
# # Print the results
...
# print(f'Prediction for {file_1x8x32}: {prediction_1x8x32[0]}')