...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_files_dir', type=str, default="/home/srchand/Desktop/research/TVM_Intel_Fork/tvm/vta/sri_scripts/ro_uart_logs/profiling_data/rcg/csvs",
                        help='apm log files dir')
    parser.add_argument('--networks_file', type=str, default="/home/srchand/Desktop/research/TVM_Intel_Fork/tvm/vta/sri_scripts/profiling_results/ro_uart/rcg/networks_profiled.log",
                        help='profiled networks list')
    parser.add_argument('--output_dataset_dir', type=str, default="dataset/ro_uart/rcg",
